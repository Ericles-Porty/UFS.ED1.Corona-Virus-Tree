...
public class Menu {
    ...
    private static final Arvore[] Floresta = new Arvore[2];
    private static TipoNo no;
    private static int travaOpcao = 0;
    private static int travaOpcaoRegiao = 0;
            ...
            case 1:
                if (travaOpcao++ == 0) {
                    try {
                        ...
                        System.out.println("Ocorreu um erro gravissimo ao abrir o arquivo!!!");
                        Sair();
                    }
                    CriaFloresta();
                    ApagaMatriz();
    ...
    private static void Loading() throws FileNotFoundException {
        ...
        ultimaData = Arquivo.PegaLastDate(path[3]);
    ...
    private static void Inicializar() {
        ...
        switch (opcaoMenu) {
            ...
            case 2:
                LimparTela();
                chaveMenu = JOptionPane.showInputDialog("Digite o codmun ou coduf") + ultimaData;
                System.out.println("Pesquisa na arvore binaria:");
                no = Floresta[idArvoreBB].Pesquisa(chaveMenu);
                contadorPesquisa = Floresta[idArvoreBB].Consultas(chaveMenu);
                Floresta[idArvoreBB].contadorPesquisa = 1;
    ...
    private static void GuardaDadosRegiao() {
        regiaoBB = Arquivo.GuardaRegioes(ultimaData, Floresta[idArvoreBB]);
        regiaoAVL = Arquivo.GuardaRegioes(ultimaData, Floresta[idArvoreAVL]);
    }
